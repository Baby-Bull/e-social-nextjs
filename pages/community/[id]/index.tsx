...
const Community = ({ communityInfo, url }) => (
  <React.Fragment>
    <Head>
      <meta property="og:type" content="TEST-COMMUNITY" key="og-type" />
      <meta property="og:title" content={`THIS IS COMMUNITY: ${communityInfo.name}`} key="og-title" />
      ...
      <meta name="twitter:card" content={`THIS IS COMMUNITY: ${communityInfo.name}`} key="twitter-card" />
      ...
      <meta name="twitter:title" content={`THIS IS COMMUNITY: ${communityInfo.name}`} key="twitter-title" />
