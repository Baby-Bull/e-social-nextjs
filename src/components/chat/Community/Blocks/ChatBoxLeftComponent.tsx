...
import { Box, Grid, IconButton, Menu, MenuItem, Paper, Tab, Tabs, Typography } from "@mui/material";
...
import { listThreadsCommunityMockData } from "../../mockData";
...
const ChatBoxLeftComponent = ({ toggleRenderSide }) => {
  ...
  const [listThreads] = useState(listThreadsCommunityMockData);
      ...
      <Box className="box-search">
        ...
        >
          ...
          <InputCustom
            ...
            inputProps={{ "aria-label": t("chat:community-box-left-input-search-placeholder") }}
          />
        </Paper>
      </Box>
