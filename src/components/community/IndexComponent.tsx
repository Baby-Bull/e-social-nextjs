...
const CommunityComponent: FC<Props> = ({ communityInfo, communityMembers }) => {
  ...
  return (
    <LayoutComponent>
      ...
      >
        ...
        <Box>
          <BannerComponent data={communityInfo} />
        </Box>
        ...
        >
          ...
          >
            <IntroCommunityComponent data={communityInfo} />
          </Box>
            ...
            >
              {communityMembers?.map((member, index) => (
                <React.Fragment key={index.toString()}>
                  ...
                  >
                    <Avatar sx={{ width: "72px", height: "72px" }} src={member?.profile_image} alt={member?.username} />
          ...
          <Box
            sx={{
              ...
              borderRadius: "12px",
              display:
                !communityInfo?.is_public &&
                (!communityInfo?.community_role || communityInfo?.community_role === PENDING)
                  ? "none"
                  : "block",
            }}
          >
            {((communityInfo?.community_role && communityInfo?.community_role !== PENDING) ||
              communityInfo?.is_public) && <TabComponent data={tabsCommunity} dataCommunityDetail={communityInfo} />}
          ...
          >
            <Box sx={{ textAlign: "center" }}>
              ...
              <ButtonComponent
                ...
                onClick={communityInfo?.community_role !== PENDING ? handleJoinCommunity : null}
                props={{
                  bgColor: communityInfo?.community_role === PENDING ? theme.gray : theme.orange,
                }}
              >
                {communityInfo?.community_role === PENDING
