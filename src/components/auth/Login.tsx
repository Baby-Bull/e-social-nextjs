        ...
        <div className={styles.boxLoginLeft}>
          <Typography component="div">
            <Box sx={{
              ...
              fontSize: 20,
              color: '#ffffff'
            }} className={ styles.boxLoginLeftTitle }>{ t('login:left.title') }</Box>
          </Typography>
        ...
        <div className={styles.boxLoginRight}>
          <Typography component="div">
            <Box sx={{
              ...
              fontSize: 20,
              color: '#1A2944'
            }} className={styles.boxLoginRightTitle}>{ t('login:right.title') }</Box>
          </Typography>
          <Typography component="div">
            <Box sx={{
              mt: 5,
              ...
              ml: "124px",
              mr: "116px"
            }} className={styles.boxLoginRightDescription}>{ t('login:right.description') }</Box>
          </Typography>
          <Box sx={{
            textAlign: 'center',
            mt: "68px",
            ...
            <Button variant="contained" className={clsx(styles.btnLoginSocial, styles.btnLoginSocialTW)}>
              <Box sx={{
                ...
                <Box sx={{
                  ml: 2,
                }}>{ t('login:right.register-twitter') }</Box>
              </Box>
            </Button>
          </Box>
          ...
          <Box sx={{
            ...
            <Button variant="contained" className={clsx(styles.btnLoginSocial, styles.btnLoginSocialGG)}>
              <Box sx={{
                ...
                <Box sx={{
                  ml: 2,
                }}>{ t('login:right.register-google') }</Box>
              </Box>
            </Button>
          </Box>
          ...
          <Box sx={{
            ...
            <Button variant="contained" className={clsx(styles.btnLoginSocial, styles.btnLoginSocialGit)}>
              <Box sx={{
                ...
                <Box sx={{
                  ml: 2,
                }}>{ t('login:right.register-git') }</Box>
              </Box>
            </Button>
          </Box>
          <Typography component="div">
            <Box sx={{
              ...
              fontSize: 14,
              color: '#1A2944',
            }} className={styles.clickRegisterAt}>{ t('login:right.click-at') }
              <Link href="/#" sx={{
                color: "#03BCDB"
              }}>
