...
var _dProjectKiaisoftGoodhubTechFrontendNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs = _interopRequireDefault(__webpack_require__(4051));
function _arrayLikeToArray(arr, len) {
    if (len == null || len > arr.length) len = arr.length;
    for(var i = 0, arr2 = new Array(len); i < len; i++)arr2[i] = arr[i];
    return arr2;
...
function _loadGetInitialProps() {
    _loadGetInitialProps = _asyncToGenerator(_dProjectKiaisoftGoodhubTechFrontendNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.mark(function _callee(App, ctx) {
        var ref, message, res, props, message1;
        return _dProjectKiaisoftGoodhubTechFrontendNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.wrap(function _callee$(_ctx) {
...
/* harmony import */ var next_dist_server_web_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5213);
        ...
        var mod = __webpack_require__(7976)
...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ middleware; }
});
...
function middleware(request) {
    const shouldHandleLocale = !PUBLIC_FILE.test(request.nextUrl.pathname) && !request.nextUrl.pathname.includes("/api/") && request.nextUrl.locale === "default";
    return shouldHandleLocale ? response.NextResponse.redirect(`/ja${request.nextUrl.href}`) : undefined;
};
